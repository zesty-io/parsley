...
// if we were to use yaml
const inFile = path.join(__dirname, '../', 'syntaxes', 'parsley.YAML-tmLanguage');
const outFile = path.join(__dirname, '../', 'syntaxes', 'parsley-monarch-tokenizer.json');
    ...
    patterns.forEach(pattern => {
        if (pattern.include) {
            ...
            if(subrule !== undefined){
                ...
                if(subrule.hasOwnProperty("patterns")){
